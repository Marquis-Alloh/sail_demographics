...
#file path
ctv3_to_readv2_map <- read_csv(here("Project","codelists","raw","ctv3rctmap_uk_20200401000002.csv.xz"))
ethnicity_ctv3_codes  <- read_csv(here("Project","codelists","raw","opensafely-ethnicity-2020-04-27.csv"))
readv2_lookup  <- read_csv(here("Project","codelists","raw","readv2_codes_descriptions.csv.xz"))
...
write.csv(ethnicity_read_v2, here("Project","codelists","ethnicity_readv2.csv"))
